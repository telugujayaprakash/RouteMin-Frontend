...
function Footer () {
  return (
    <footer
      id='footer'
      className='border-t border-slate-200/80 bg-white text-slate-700 relative z-20'
    >
      <div className='mx-auto grid max-w-7xl gap-10 px-6 py-14 lg:grid-cols-12 lg:px-8'>
        ...
        <div className='lg:col-span-4 space-y-4'>
          ...
          <p className='max-w-sm text-xs leading-relaxed text-slate-500 font-medium'>
            Transportation optimization for smarter supply chain decisions.
            RouteMin enables factory-to-warehouse route allocation and freight
            cost minimization.
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-8'>
          ...
          <div>
            ...
            <div className='flex items-center gap-2'>
              <button
                aria-label='LinkedIn'
                className='flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 text-slate-600 transition-all hover:bg-blue-50 hover:text-blue-600 hover:border-blue-300 cursor-pointer'
              >
